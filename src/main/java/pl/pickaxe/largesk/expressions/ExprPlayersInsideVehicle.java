...
public class ExprPlayersInsideVehicle extends SimpleExpression<Player> {
  ...
  public static void register() {
    Skript.registerExpression(ExprPlayersInsideVehicle.class, Player.class, ExpressionType.SIMPLE,
