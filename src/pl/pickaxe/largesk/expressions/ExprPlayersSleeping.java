...
public class ExprPlayersSleeping extends SimpleExpression<Player> {
  ...
  public static void register() {
    Skript.registerExpression(ExprPlayersSleeping.class, Player.class, ExpressionType.SIMPLE, "%players% sleeping",
        "sleeping %players%");
  }
}
