...
public class Events {
  ...
  public void registerGeneral() {
    ...
    Skript.registerEvent("console log", SimpleEvent.class, EvtConsoleLog.class,
        new String[] {"[console] log[ging]"});

    // EvtConsoleLog getMessage()
    EventValues.registerEventValue(EvtConsoleLog.class, String.class,
        new Getter<String, EvtConsoleLog>() {
          @Override
    ...
    // Chunk Change Event
    Bukkit.getServer().getPluginManager().registerEvents(new PlayerChunkChangeEvt(),
        LargeSk.getPluginInstance());

    Skript.registerEvent("chunk change", SimpleEvent.class, EvtPlayerChunkChange.class,
        new String[] {"chunk change"});
  ...
  public void registerAAC() {
    // Register Events
    Bukkit.getServer().getPluginManager().registerEvents(new PlayerViolationEvt(),
        LargeSk.getPluginInstance());

    // Register EvtPlayerViolation to Skript
    Skript.registerEvent("Player Violation", SimpleEvent.class, EvtPlayerViolation.class,
        new String[] {"violation", "hack", "cheat"});

    // EvtPlayerViolation getPlayer()
    EventValues.registerEventValue(EvtPlayerViolation.class, Player.class,
        new Getter<Player, EvtPlayerViolation>() {
          @Override
    ...
    EventValues.registerEventValue(EvtPlayerViolation.class, HackType.class,
        new Getter<HackType, EvtPlayerViolation>() {
          @Override
    ...
    EventValues.registerEventValue(EvtPlayerViolation.class, String.class,
        new Getter<String, EvtPlayerViolation>() {
          @Override
    ...
    EventValues.registerEventValue(EvtPlayerViolation.class, Integer.class,
        new Getter<Integer, EvtPlayerViolation>() {
          @Override
